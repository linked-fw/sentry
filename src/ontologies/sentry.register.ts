 ...
 *
 * Kept out of `sentry.ts` because registration needs that module's whole export
 ...
 */
import * as terms from './sentry.js';
import {loadData, ns} from './sentry.js';
import {linkedOntology} from '../package.js';

linkedOntology(terms, ns, 'sentry', loadData, '../data/sentry.json');
